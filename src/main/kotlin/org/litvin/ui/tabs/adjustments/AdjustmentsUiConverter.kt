 ...
 * - Brightness slider: [-100..+100] -> model.brightness [-1.0..+1.0]
 * - Contrast slider:   [-100..+100] -> model.contrast   [0.0..3.0] via ((v/100)+1)
 * - Saturation slider: [-100..+100] -> model.saturation [0.0..3.0] via ((v/100)+1)
...
object AdjustmentsUiConverter {
    ...
    fun slidersToModel(
        ...
        val b = ((brightness / 100.0f) + 1.0f).coerceIn(0.0f, 3.0f)
        val c = ((contrast / 100.0f) + 1.0f).coerceIn(0.0f, 3.0f)
        val s = ((saturation / 100.0f) + 1.0f).coerceIn(0.0f, 3.0f)
    ...
    fun modelToSliderValues(adj: AdjustmentsV1): SliderValues {
        ...
        val b = ((adj.brightness.coerceIn(0.0f, 3.0f) - 1.0f) * 100.0f).toInt()
        val c = ((adj.contrast.coerceIn(0.0f, 3.0f) - 1.0f) * 100.0f).toInt()
        val s = ((adj.saturation.coerceIn(0.0f, 3.0f) - 1.0f) * 100.0f).toInt()
